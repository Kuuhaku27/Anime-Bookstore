window.onload = function(){
	...
	var booksPdf = [
		'pdf/Boku no Hero Academia chp 1.pdf',
		'pdf/Boku no Hero Academia chp 2.pdf',
		'pdf/Boku no Hero Academia chp 3.pdf',
		'pdf/Boku no Hero Academia chp 4.pdf',
		'pdf/One Punch Man chp 1.pdf',
		'pdf/One Punch Man chp 2.pdf',
		'pdf/One Punch Man chp 3.pdf',
		'pdf/One Punch Man chp 4.pdf',
		'pdf/Naruto Shippuden chp 1.pdf',
		'pdf/Naruto Shippuden chp 2.pdf',
		'pdf/Naruto Shippuden chp 3.pdf',
		'pdf/Naruto Shippuden chp 4.pdf',
		'pdf/ReLife chp 1.pdf',
		'pdf/ReLife chp 2.pdf',
		'pdf/ReLife chp 3.pdf',
		'pdf/ReLife chp 4.pdf'
	]
	...
	function onMouseDown ( event ) {
		...
		document.getElementById('text-help').innerHTML = "Anime Bookstore";
		for(var i=0; i < shelf.children.length; i++){
		...
		for ( var i = 0; i < intersects.length; i++ ) {
			...
			document.getElementById('text-help').innerHTML = "klik 2x untuk melihat buku";
